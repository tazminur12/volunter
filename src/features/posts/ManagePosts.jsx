...
const ManagePosts = () => {
    ...
    const { useUserPosts, useUserVolunteerRequests, useDeletePost, useCancelVolunteerRequest } = usePostQueries();
    const { data: posts = [], isLoading: postsLoading } = useUserPosts(user?.email);
    const { data: requests = [], isLoading: requestsLoading } = useUserVolunteerRequests(user?.email);
    const deletePostMutation = useDeletePost();
    const cancelRequestMutation = useCancelVolunteerRequest();

    const loading = postsLoading || requestsLoading;
